...
it will have different languages which rtl and ltr in the future so make use of start and end instead of left and right.
...
right now i have completed the Home, About, , News And Events, Contact Us, Gallery, teacher profile, Awards and achievements and testimonials pages and have these plus other components.
Navbar, Footer, CTASection, PageHeader and others which can be imported from components/ or components/layout/

now i want you to make the Academic Programs Page section(
also i have some more info about this part it me useful for yoy

---

The page must include the following sections and content:

1️⃣ Hero Section (Top of Page)

Create a visually strong opening section that includes:

Page title:
"Academic Programs"

Subtitle:
"Empowering students through quality education, structured learning, and future-focused programs."

Short introduction paragraph explaining:

The school offers well-designed academic programs

Focus on knowledge, skills, discipline, and innovation

Preparation for higher education and real-world success

2️⃣ Overview of Academic Programs

Write a clear section that explains:

Sultan Zoy High School provides education from:
...
Explain that the curriculum is designed to:

Develop strong academic foundations

Encourage critical thinking

Promote moral values and responsibility

3️⃣ Grade Levels & Streams

Create structured cards or sections for:

🔹 Primary School (Grades 1–6)

Include:

Core subjects (Math, Language, Science, Social Studies)

Focus on reading, writing, creativity, and confidence building
...
Focus on problem-solving, research, and teamwork

🔹 High School (Grades 10–12)

Include streams such as:
...
Technology (optional)
Explain that students are prepared for:
...
Add short descriptions for key subjects.

5️⃣ Teaching Methodology

Explain how learning happens at the school:
...
Explain that teachers focus on:
...
Teachers follow structured lesson plans

7️⃣ Examination & Assessment
...
Describe how grades are used to:
...
Explain that students receive:

High-quality academic materials

Updated content

9️⃣ Academic Support
...
Explain that no student is left behind.
