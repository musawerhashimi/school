...
import { useEffect, useState } from "react";
import { TripCardSkeleton } from "./Skilton";
import { getStatus, getStatusLabel } from "@/utils/stutusFunction";
        ...
        <div className="bg-card border border-border rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-500">
          <div className="relative h-64 overflow-hidden">
            ...
            <div className="absolute top-4 left-4">
              <span
                className={`badge border backdrop-blur-sm bg-white/90 ${getStatusColor(
                  status,
          ...
          <div className="p-6">
            ...
            <p className="text-text-secondary mb-4">{trip.description[lang]}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {trip.duration} {t("educationalTrips.day")}
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                {t("educationalTrips.gradeLevels")} {trip.gradeLevels}
              </div>
            </div>
          </div>
        </div>
