...
//               <span>
//                 {category !== "all"
//                   ? getCategoryById(category)?.name[lang]
...
//                     }`}
//                   >
//                     <span className="font-medium">{cat.name[lang]}</span>
//                   </button>
//                 ))}
//               </div>
//             )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="relative">
            <button
              onClick={() => setIsCategoryDropdownOpen(!isCategoryDropdownOpen)}
              className="w-full px-6 py-2.5 rounded-full border flex justify-between"
            >
              <span>
                {category !== "all"
                  ? getCategoryById(category)?.name[lang]
            ...
            {isCategoryDropdownOpen && (
              <div className="absolute bg-card border w-full mt-2 rounded-xl z-20">
                <button
                  onClick={() => handleCategorySelect("all")}
