...
export const NewsCard: React.FC<NewsCardProps> = ({
  ...
  return (
    <article
      className={`group bg-card border border-border rounded-2xl overflow-hidden hover:shadow-2xl hover:border-primary/50 transition-all duration-500 col-span-1 flex flex-col h-full`}
    >
      {/* Image */}
