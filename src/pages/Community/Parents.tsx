...
//               <div
//                 key={index}
//                 className={`${way.color} rounded-2xl p-8 transition-all duration-300 transform hover:scale-105 hover:shadow-xl border border-gray-200`}
//               >
//                 <div
//                   className={`${way.iconBg} w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mb-6 shadow-lg`}
//                 >
//                   {way.icon}
//                 </div>
//                 <h3 className="font-bold text-xl mb-3 text-gray-900">
...
//       <section className="py-10 px-6 bg-gradient-to-br from-primary/5 to-purple-50">
//         <div className="max-w-6xl mx-auto">
...
//               <div
//                 key={index}
//                 className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200"
//               >
...
//         <div className="max-w-6xl mx-auto">
//           <div className="bg-gradient-to-br from-primary/10 to-purple-50 rounded-3xl p-12 shadow-xl">
//             <div className="text-center mb-12">
//               <h2 className="text-4xl font-bold text-gray-900 mb-4">
...
//       {/* CTA Section */}
//       <section className="relative bg-gradient-to-r from-primary to-primary/80 text-white py-10 overflow-hidden">
...
//             <button className="bg-white text-primary font-bold px-8 py-4 rounded-xl hover:scale-105 hover:shadow-2xl transition-all duration-300">
//               {t("involvement.cta.primaryButton")}
//             </button>
//             <button className="bg-primary-foreground/10 backdrop-blur-sm border-2 border-white text-white font-bold px-8 py-4 rounded-xl hover:bg-white hover:text-primary transition-all duration-300">
//               {t("involvement.cta.secondaryButton")}
//             </button>
//           </div>
//         </div>
//       </section>
